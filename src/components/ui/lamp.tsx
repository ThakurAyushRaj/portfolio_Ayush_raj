...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-full flex-col items-center justify-center overflow-hidden w-full z-0",
        className
      )}
    >
      <div className="relative flex w-full items-center justify-center isolate z-0 mt-24">
        <motion.div
        ...
        <div className="absolute inset-auto z-50 h-24 w-[16rem] -translate-y-1/2 rounded-full bg-cyan-500 opacity-50 blur-3xl"></div>
        ...
        <div className="absolute inset-auto z-40 h-24 w-full -translate-y-[6rem] bg-black"></div>
      </div>

      <div className="relative z-50 flex flex-col items-center px-5 -translate-y-12 text-center w-full">
        {children}
      </div>
    </div>
  );
